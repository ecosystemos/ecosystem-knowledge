  ...
  return (
    ...
    <Flex direction={"column"} > 
            ...
            <Flex direction={"row"}>
                ...
                <Box marginLeft={"120px"} marginTop={"5px"}> <Link><Icon icon="ph:pencil-line-light"  color="#5A6D72"   height="13" width="13" /> </Link> </Box>
                <Box marginLeft={"10px"} marginTop={"5px"}> <Link><Icon icon="akar-icons:trash-can"  color="#5A6D72" height="13" width="13" /> </Link></Box> 
            </Flex>
                <TextWrapper> 
